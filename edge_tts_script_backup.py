...
params = {
    'activate': True,
    'speaker': 'en-US-JennyNeural', # Set default tts
    'language': 'en',
    'show_text': True,
    'autoplay': True,
    'rvc': True,  # Turn on RVC by default
    'rvc_model': 'GanyuEN-1.pth',  # Set default RVC model
    'transpose': 2,
    'index_rate': 1,
    'protect': 0.33
}
...
def refresh(x): 
    global voices, current_params, rvc_models
    ...
    if params['speaker'] not in voices:
        params['speaker'] = 'en-US-JennyNeural'
